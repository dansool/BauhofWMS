...
namespace BauhofWMS.Utils
{
    public class CheckNewVersion
    {
        ...
        //                if (userAllowedMinor)
        //                {
        //                    Debug.WriteLine("ParseVersionToList.Get(minorPublished)");
        //                    var lstPublishedVersion = ParseVersionToList.Get(minorPublished);
        //                    Debug.WriteLine("ParseVersionToList.Get(currentVersion)");
        //                    var lstCurrentVersion = ParseVersionToList.Get(currentVersion);
        ...
        //                else
        //                {
        //                    Debug.WriteLine("ParseVersionToList.Get(publishedVersion)");

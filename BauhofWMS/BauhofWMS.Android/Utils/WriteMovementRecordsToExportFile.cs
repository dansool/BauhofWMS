...
[assembly: Dependency(typeof(WriteMovementRecordsToExportFile))]

namespace BauhofWMS.Droid.Utils
{
    public class WriteMovementRecordsToExportFile : IWriteMovementRecordsToExportFileAndroid
    {
        WriteLog WriteLog = new WriteLog();
        public async Task<string> WriteMovementRecordsToExportFileAsync(string data, string exportFileStamp, string shopLocationID, string deviceSerial)
        {
            string result = "";

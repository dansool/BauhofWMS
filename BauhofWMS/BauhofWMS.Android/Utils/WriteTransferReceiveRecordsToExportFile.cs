...
[assembly: Dependency(typeof(WriteTransferReceiveRecordsToExportFile))]

namespace BauhofWMS.Droid.Utils
{
    public class WriteTransferReceiveRecordsToExportFile : IWriteTransferReceiveRecordsToExportFileAndroid
    {
        public async Task<string> WriteTransferReceiveRecordsToExportFileAsync(string data, string exportFileStamp)
        {
            string exportFileName = "TRFRCV_" + exportFileStamp + ".TXT";
            try
            {
            ...
            {
                return "WriteTransferReceiveRecordsToExportFileAsync " + ex.Message + "  " + exportFileStamp;
            }
        }
    }
}
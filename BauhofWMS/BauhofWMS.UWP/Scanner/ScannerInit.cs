...
namespace BauhofWMS.UWP.Scanner
{
    public class ScannerInit
    {
        ...
        public async Task Scanned(Windows.Devices.PointOfService.BarcodeScannerDataReceivedEventArgs args)
        {
            try
            {
                ...
                MessagingCenter.Send<BauhofWMS.App, string>((BauhofWMS.App)obj.BauhofWMSApp, "scannedValue", scannedCode + "###" + scannedSymbology);
            }
            catch (Exception ex)
            {
                MessagingCenter.Send<BauhofWMS.App, string>((BauhofWMS.App)obj.BauhofWMSApp, "exception", "ScrannerInit/Scanned: " + ex.Message);
            }
        }
        ...
        private async Task<Tuple<bool, string>> InitializeScannerAsync()
        {
            try
            {
                ...
                if (App.claimedScanner != null)
                {
                    ...
                    MessagingCenter.Send<BauhofWMS.App, string>((BauhofWMS.App)obj.BauhofWMSApp, "scannerInitStatus", "true");
        ...
        public async void ClaimedScanner_DataReceivedAsync(Windows.Devices.PointOfService.ClaimedBarcodeScanner sender, Windows.Devices.PointOfService.BarcodeScannerDataReceivedEventArgs args)
        {
            ...
            {
                MessagingCenter.Send<BauhofWMS.App, string>((BauhofWMS.App)obj.BauhofWMSApp, "exception", "ScrannerInit/ClaimedScanner_DataReceivedAsync: " + ex.Message);
            }
        }
        ...
        public async Task<string> GetData(Windows.Storage.Streams.IBuffer data, uint scanDataType)
        {
            ...
            {
                MessagingCenter.Send<BauhofWMS.App, string>((BauhofWMS.App)obj.BauhofWMSApp, "exception", "ScrannerInit/GetData: " + ex.Message);
            }
            return "";
        }
        ...
        public void OnClaimedScannerReleaseDeviceRequested(object sender, Windows.Devices.PointOfService.ClaimedBarcodeScanner e)
        {
            ...
            {
                MessagingCenter.Send<BauhofWMS.App, string>((BauhofWMS.App)obj.BauhofWMSApp, "exception", "ScrannerInit/OnClaimedScannerReleaseDeviceRequested: " + ex.Message);
            }
        }
        ...
        private async Task<bool> LastTryAsync()
        {
            ...
            {
                MessagingCenter.Send<BauhofWMS.App, string>((BauhofWMS.App)obj.BauhofWMSApp, "exception", "ScrannerInit/LastTryAsync: " + ex.Message);
                return false;
            }
        }
        ...
        public async Task<string> GetData(Windows.Storage.Streams.IBuffer data)
        {
            ...
            {
                MessagingCenter.Send<BauhofWMS.App, string>((BauhofWMS.App)obj.BauhofWMSApp, "exception", "ScrannerInit/GetData IBuffer: " + ex.Message);
                return "";
            }
        }
    }
